...
Prioritäten: fachliche Richtigkeit, klare altersgerechte Sprache, korrekte Lösungen, abwechslungsreiche Aufgaben, realistische Bearbeitungszeit und exakte Punktvorgaben. Prüfe jede Aufgabe vor der Ausgabe gegen ihre eigene Lösung: Es muss eine eindeutig richtige Lösung geben, falsche Antwortoptionen dürfen nicht gleichbedeutend zur richtigen sein.\n
...
Qualitätsprüfung vor der Ausgabe: Die Lösung darf nicht bereits im Fragetext, in der Aufgabenstellung oder im abgebildeten Beispiel stehen. Bei Aufgaben zur Anzahl von Kommas zeige den zu bearbeitenden Satz ohne bereits gesetzte Kommas. Bildantworten müssen die Frage eindeutig und fachlich sinnvoll prüfen: gleiche genannten Gegenstände in allen Varianten einer räumlichen Beziehung, nur die Beziehung variiert. Keine austauschbaren Gegenstände wie Ball statt Buch. Zeitliche oder abstrakte Begriffe wie „wieder“ lassen sich durch ein einzelnes Bild gewöhnlich nicht eindeutig darstellen; wähle dafür eine textbasierte Aufgabenform. Prüfe, ob jede Bildbeschreibung konkret umsetzbar und eindeutig ist.\n
